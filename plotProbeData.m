...
mean1 = [-0.0070, -0.0074, -0.0235, -0.0146, -0.0379, 0.0012];
max1 = [7.8337e-04, 0.0010, 0.0053, 0.0054, 0.0012, 0.0088];
min1 = [-0.0165, -0.0408, -0.0502, -0.0409, -0.0856, -0.0068];
...
%% TD155 data
% --- plots probe mean, max, and min over days ---
mean2 = [9.1022e-10, -2.4193e-04, -0.0022, -0.0086, -0.0120, -0.0084];
max2 = [4.9060e-08, 0.0071, 0.0176, 0.0096, 0.0087, 0.0087];
min2 = [-2.0960e-08, -0.0081, -0.0134, -0.0246, -0.0323, -0.0319];
